...
childAcc="691046333075"
childAccComma=${childAcc// /,}
allACC="$ACC $childAcc"
allregions="us-east-1 us-east-2"
LinkedRole1=""
S3RootURL="https://s3.amazonaws.com/aws-service-catalog-reference-architectures-ct"
S3RootURL2="https://s3.amazonaws.com/aws-service-catalog-reference-architectures"
...
aws cloudformation create-stack-set --stack-set-name ${ALIAS}-SC-IAC-automated-IAMroles --parameters "[{\"ParameterKey\":\"RepoRootURL\",\"ParameterValue\":\"$S3RootURL2/\"}]" --template-url "$S3RootURL2/iam/sc-demosetup-iam.json" --capabilities CAPABILITY_IAM CAPABILITY_NAMED_IAM CAPABILITY_AUTO_EXPAND --administration-role-arn $CFTSSAdminRole --execution-role-name $CFTSSExecRole
